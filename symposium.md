...
Le numéro de table que vous utiliserez au symposium sera indiqué ici.

## Vos besoins en terme de matériel

Une table vous sera installée avec accès à une prise électrique. Vous devez lister l'ensemble du matériel nécessaire à la présentation de votre démontration, absolument tous :

### Ce que nous avons déjà en main :

1. Ordinateur portable (De Milanne) + son fil + souris d'ordinateur + connection USB/USB-C
...
2. Une à deux chaises si besoin
